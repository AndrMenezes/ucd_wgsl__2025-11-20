...
> - **palaeoclimate studies**: break the multinomial into independent univariate 
...
but rely on simple linear regression structure:
...
<!-- - Full conditionals Gaussian updates are readily available for  -->
...
- $m_\lambda = m_\zeta = 100$ trees for $j\in\{1,\ldots, 28\}$. It took approximately $3$ hours for $10,000$ iterations.
...
**Future work**
  ...
  - Integrate our proposed models into the palaeoclimate reconstruction framework of `r Citet(bib, "Parnell2015")`.
  ...
  - Incorporate the multiplicative gamma process prior of `r Citet(bib, "Bhattacharya2011")` 
  into the factor-analytic covariance for the random effects of the ZANIM-LN-BART model.
]
...
RefManageR::PrintBibliography(bib, start = 12, end = 20)
```
]
